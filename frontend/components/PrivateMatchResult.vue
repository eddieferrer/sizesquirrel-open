<template>
  <div class="columns is-centered">
    <div class="column">
      <!-- found a match -->
      <div
        v-if="matchResultsLength > 0 && streetResults.length > 0"
        class="columns"
      >
        <div class="column">
          ...
          <h6>
            Percentage:
            <strong>{{ streetResults[0].percentage }}%</strong> of users with
            your same street shoe size wear this size.
          </h6>
          <progress
          ...
          <small
            >Street shoe sizing varies more than we would like and we think this
            type of match is inherently not very accurate</small
          >
        </div>
      </div>
            ...
            >
              <div class="box has-background-light">
                <p>
                  Based on the
                  <strong>{{
                    grouped_result['shoe'].model | titleCase
                  }}</strong>
                  you should get the
                  <strong
                  ...
                  <strong
                    >{{
                      grouped_result.most_common_size[
                        targetItem.short_size_standard
                      ]
                    }}
      ...
      >
        <div class="column">
          ...
          <h6>
            ...
            {{ streetResults[0].size }} {{ targetItem.brand['sizing'] }}
            {{ targetItem.gender['name'] }}{% if targetItem.gender['name'] ==
            'men' or targetItem.gender['name'] == 'women'%}'s{% endif %}
          </h6>
          <h6>
          ...
          <div :class="getClass(streetResults[0].percentage)">
            <span
              class="meter"
              :style="{ width: streetResults[0].percentage + '%' }"
            ></span>
          </div>
          <h6>
