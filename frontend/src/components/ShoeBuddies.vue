<template>
  ...
  >
    <section class="section">
      <div class="columns">
        <div class="column">
          <h2 class="is-size-4 has-text-centered has-text-primary">Shoe Buddies</h2>
          <h5 class="is-size-5 has-text-centered">These users have the same shoes you do</h5>
          <hr />
          <template v-if="shoe_buddies.length > 0">
            ...
            >
              <p>
                ...
                <RouterLink :to="{ name: 'profile', params: { username: buddy.username } }">{{
                  buddy.username
                }}</RouterLink
                >.
              </p>
        ...
        <div class="column">
          <h2 class="is-size-4 has-text-centered has-text-primary">Best Shoe Buddies</h2>
          ...
          <div v-if="best_shoe_buddies.length == 0" class="box has-background-light">
